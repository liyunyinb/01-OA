...
@Data
@ApiModel("待验收货物信息表的实体类")
@TableName(value = "wm_im_notice_i")
public class ToAcceptDTO {
    ...
    private Integer goodsQmCount;  // goods_qm_count -> goodsQmCount
    ...
    @ApiModelProperty(value = "到货客户代码(客户订单号)", example = "X00001")
