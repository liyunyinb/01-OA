...
*/
#ifndef _DOWNLOADEXCEL_DTO_
#define _DOWNLOADEXCEL_DTO_
 ...
 * excel文件下载数据对象
 */
class DownloadExcelDTO : public oatpp::DTO
{
	DTO_INIT(DownloadExcelDTO, DTO);
	// excel文件名
...
public:
	DownloadExcelDTO() {}
	DownloadExcelDTO(String filename, String alt = "", String href = "")
	{
