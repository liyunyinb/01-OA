...
uint64_t InfoFileDAO::insert(const InfoFileDO& iObj) {
	...
	* 8
	...
	com_type_code -- 企业等级编码
	com_type_name -- 奇特等级名称
	*/

	// 准备sql语句 
	string sql = "INSERT INTO `ba_com_deg` (`id`, `create_name`, `create_by`,`create_date`,`sys_org_code`, `sys_company_code`, `com_deg_code`, `com_deg_name`) VALUES (?,?,?,?,?,?,?,?)";
