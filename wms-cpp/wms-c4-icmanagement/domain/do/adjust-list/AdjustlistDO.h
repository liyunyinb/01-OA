...
/*****************************************************************************
    ...
    *  @version  : ver 1.0
    *  @author   : kato1
    *  @date     : 2025/2/27 14:47
    *  @brief    : brief
*****************************************************************************/
#ifndef _AdjustlistDO_
#define _AdjustlistDO_
#include "../DoInclude.h"
...
// 给AdjustlistDO智能指针设定一个别名方便使用
typedef std::shared_ptr<AdjustlistDO> PtrAdjustlistDO;


#endif // !_AdjustlistDO_