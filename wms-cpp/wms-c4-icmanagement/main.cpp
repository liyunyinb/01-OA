...
void parseServerArgs(int argc, char* argv[]) {
	...
	// 数据库连接信息
	// 
	std::string dbUsername = "zo_wms";
	std::string dbPassword = "kekoukele";
	std::string dbName = "zo_wms";
	std::string dbHost = "182.92.76.127";
	int dbPort = 3369;

	//std::string dbUsername = "root";
	//std::string dbPassword = "007007";
	//std::string dbName = "jeewms";
	//std::string dbHost = "192.168.146.173";
	//int dbPort = 3306;

	int dbMax = 5;
#ifdef LINUX
	// Nacos配置参数
	std::string nacosAddr = "47.94.0.110:8848";
	std::string nacosNs = "wms-dev";
